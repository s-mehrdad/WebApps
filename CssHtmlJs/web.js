...
function changeStyle() {
  console.assert(
    ...
    true,
    (document.getElementById("JavaScript").style.backgroundColor = "#f0820d")
  );
  console.assert(
    document.getElementById("JavaScriptTwo"),
    false,
    (document.getElementById("JavaScript").style.backgroundColor = "#31a7f9")
  );
